...
public static class StringExtensions
{
    ...
    public static string KeepOnlyLettersAndSpaces(this string input, string replacement)
    {
        if (string.IsNullOrEmpty(input))
            return string.Empty;

        return RegexUtilities.LettersAndSpaces.Replace(input, replacement);
    }

    public static string StripHtml(this string input)
    {
        return RegexUtilities.InnerHtmlTag.Replace(input, string.Empty);
    }

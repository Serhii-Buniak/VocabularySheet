...
using VocabularySheet.Maui.Domain;
...
namespace VocabularySheet.Maui.AppRunner.ViewModels;
...
public partial class WordDetailsVm : BaseViewModel
{
    ...
    [ObservableProperty] private AppRunner.ViewModels.LinkBoxVm _box;
    ...
    public WordDetailsVm(IMediator mediator, ILogger<WordDetailsVm> logger, IAudioManager audioManager, StreamFetcherClient fetcher) : base(mediator, logger)
    {
        ...
        _fetcher = fetcher;
        _box = new AppRunner.ViewModels.LinkBoxVm(mediator, logger);
    }

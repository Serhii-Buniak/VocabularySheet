...
{
    public HeaderValidationEmptyException(CsvContext context) : base(context, Array.Empty<InvalidHeader>(), "CsvStreamers file is empty")
    {
    }
}
...
public static class CsvParser
{
    ...
    public static IAsyncEnumerable<T> DeserializeAsync<T>(this CsvConfiguration configuration, Stream stream, CancellationToken cancellationToken)  where T : ICsvFile
    {
